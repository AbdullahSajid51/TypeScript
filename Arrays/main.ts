...
let arry3: (string | number)[] = ["Ali", "Musa", "Kazim", 5, 7, 8, 6];
let arry2: number[] = [5, 7, 8, 6];
// -------------------------------------------

// 2) Make an array by using constructor:
// Array Constructor:
const num1: number[] = new Array(1, 2, 3, 4, 5);
// -------------------------------------------

// 3) Make an array by using Array.of method:
const names1: string[] = Array.of("Musa", "Ali", "Hassan");
// -------------------------------------------
...
let fruits: Array<string> = ["apple", "mango", "grapes", "cherry"]; // Generic type
...
// 2) Using For-of Loop:
let Cities: string[] = ["Karachi", "Hyderabad", "Mumbai", "Lucknow"];
...
// 1) Map Methode: (creates a new array) (map methods targets every elements in the array.)
...
const doubleData: number[] = numbers.map(
...
//--------------------------------------
const numberToString = numbers.map((currentValue: number) =>
...
let arrOFStrings: string[] = ["Ali", "Abbas", "Musa", "Ammaar", "Jafar"];
let upperCaseVersion: string[] = arrOFStrings.map((currVal) =>
  currVal.toUpperCase()
);
...
let squareOFNum: number[] = numbers.map((num) => num ** 2);
console.log(numbers);
...
// const evenNum = numbers.filter((val: number) => val % 2 === 0);
const evenNum = numbers.filter((val: number) => {
  val % 2 === 0;
});
console.log(numbers);
console.log(evenNum);
...
//* const names: string[] = ["Alice", "Bob", "Anna", "Andrew", "Alex"];
const names: string[] = ["Alice", "Bob", "Anna", "Andrew", "Alex"];
const newArray: string[] = names.filter((value) => value.length > 4);
console.log(names);
...
const newArray = names.filter((curVal: string) => {
...
const names: string[] = ["Ali", "Abbas", "Musa", "Ammaar", "Jafar"];

// Filter the array to exclude strings that start with the letter "A"
// const filteredNames: string[] = names.filter(name => !name.startsWith("A"));

// Filter the array to include strings that start with the letter "A"
const filteredNames: string[] = names.filter((name) => name.startsWith("A"));
...
console.log(findMaxValue([1000, 18, 9, 4])); // Output: 1000
// ------------------------------------------------------------------
